...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKi 25.50
  #define DEFAULT_bedKd 452.70
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -14, -1.15 }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_BKGD_INDEX_LAST   18              // Index of the last background LED
